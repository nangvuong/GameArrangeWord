...
public class MatchSummary {
    ...
    public void setUser1TotalScore(int user1TotalScore) {
        this.user1TotalScore = user1TotalScore;
    }
    ...
    public void setUser2TotalScore(int user2TotalScore) {
        this.user2TotalScore = user2TotalScore;
    }
    ...
    public void setUser1Wins(int user1Wins) {
        this.user1Wins = user1Wins;
    }
    ...
    public void setUser2Wins(int user2Wins) {
        this.user2Wins = user2Wins;
    }
    ...
    public int getOpponentScore(int currentUserId) {
        return (currentUserId == user1Id) ? user2Score : user1Score;
    }
